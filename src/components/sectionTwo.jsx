  ...
  return (
    <section className="flex flex-col items-center h-screen p-14 md:justify-center">
      ...
      <article className="flex flex-wrap justify-center gap-8 mt-20">
        ...
        <div className="flex flex-col items-center space-y-4 hover:text-[#333333]">
          <FaGithub className="text-6xl" />
          <p className="text-xl">GitHub</p>
        </div>
        <div className="flex flex-col items-center space-y-4 hover:text-[#38B2AC]">
          <SiTailwindcss className="text-6xl" />
          <p className="text-xl">Tailwind</p>
        </div>
        <div className="flex flex-col items-center space-y-4 hover:text-[#F7DF1E]">
          <IoLogoJavascript className="text-6xl" />
          <p className="text-xl">JavaScript</p>
        </div>
        <div className="flex flex-col items-center space-y-4 hover:text-[#68A063]">
          <FaNodeJs className="text-6xl" />
          <p className="text-xl">NodeJs</p>
        </div>
        <div className="flex flex-col items-center space-y-4 hover:text-[#007ACC]">
          <SiTypescript className="text-6xl" />
          <p className="text-xl">TypeScript</p>
        </div>
        <div className="flex flex-col items-center space-y-4 hover:text-[#F05032]">
          <FaGitSquare className="text-6xl" />
          <p className="text-xl">Git</p>
        </div>
        <div className="flex flex-col items-center space-y-4 hover:text-[#00758F]">
