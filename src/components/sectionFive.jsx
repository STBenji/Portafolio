        ...
        <div>
          <ol className="relative border-gray-200 border-s dark:border-gray-700">
            <li className="mb-10 ms-6" data-aos="fade-right">
              <span className="absolute flex items-center justify-center w-4 h-4 bg-green-100 rounded-full -start-8 ring-4 ring-white dark:ring-gray-900 dark:bg-green-900"></span>
